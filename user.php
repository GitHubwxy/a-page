<?php 
//-----------------------请修改以下配置(注意：解析客户端只支持PHP版本为：5.6~7.2，推荐7.0！)------------------------------------
...
$user = array(
		...
		'uid' => '88903939', //这里填写你的UID信息(填写在单引号内),用户授权UID，在 http://user.seakee.cn 平台可以查看

		'token' => '810f76ee4b269f45dd87fa188ef70b5a', //这里填写你的用户密匙信息(填写在单引号内),用户授权TOKEN，在 http://user.seakee.cn 平台可以查看

		'path' => '/a-page', //一般不用修改,除非你放置在根目录或其他目录，默认在8090目录，修改格式 '/8090' （修改二级目录一定看好格式），如果放在根目录就请留空，格式：'path' => ''
